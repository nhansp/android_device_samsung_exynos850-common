...
$(call soong_config_set,exynos_audio,PROXY_LIBRARY,//device/samsung/exynos850-common:libaudioproxy)
...
BOARD_MKBOOTIMG_ARGS := --base $(BOARD_KERNEL_BASE) --pagesize $(BOARD_KERNEL_PAGESIZE) --dtb_offset $(BOARD_DTB_OFFSET) --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --header_version $(BOARD_BOOTIMG_HEADER_VERSION)
...
# Init
$(call soong_config_set,libinit,vendor_init_lib,//device/samsung/exynos850-common:libinit_exynos3830)
